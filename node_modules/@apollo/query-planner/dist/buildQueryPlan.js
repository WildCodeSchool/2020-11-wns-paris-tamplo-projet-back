...
function splitSubfields(context, path, fields, parentGroup) {
    splitFields(context, path, fields, field => {
        ...
        const { scope, fieldNode, fieldDef } = field;
        const { parentType } = scope;
        const parentIsValueType = !graphql_1.isObjectType(parentType) || ((_a = composedSchema_1.getFederationMetadataForType(parentType)) === null || _a === void 0 ? void 0 : _a.isValueType);
    ...
    for (const selection of selectionSet.selections) {
        switch (selection.kind) {
            ...
            case graphql_1.Kind.INLINE_FRAGMENT: {
                ...
                collectFields(context, newScope, selection.selectionSet, fields, visitedFragmentNames);
                break;
            }
